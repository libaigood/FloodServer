 ...
 * 雨情信息_降雨
 * */
public class Rainfalls_one extends BasicInformation implements Serializable{

	private static final long serialVersionUID = -3811326151078704609L;
	...
	public Rainfalls_one(String stcd, String stnm, Date tm, double drp, String ttt, String adcd, String adnm) {
		super();
		this.stcd = stcd;
		this.stnm = stnm;
		this.tm = tm;
	...
	public String toString() {
		return "Rainfalls_one [stcd=" + stcd + ", stnm=" + stnm + ", tm=" + tm + ", drp=" + drp + ", ttt=" + ttt
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Rainfalls_one other = (Rainfalls_one) obj;
		if (adcd == null) {
			if (other.adcd != null)
				return false;
