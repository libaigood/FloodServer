...
public interface RainInfoDao {
	//雨量信息
	public List<Rainfalls_all> rainfalls_all(@Param("stm") String stm, @Param("etm") String etm, @Param("addvcd") String addvcd);
	public List<Rainfalls_one> rainfalls_one(@Param("stcd") String stcd, @Param("stm") String stm, @Param("etm") String etm);
	//雨强信息
	public List<RainIntensity_all> rainIntensity_all(@Param("stm") String stm, @Param("etm") String etm, @Param("addvcd") String addvcd);
