package com.bzh.floodserver.core.shiro;

import com.bzh.floodserver.core.shiro.CustomRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        shiroFilterFactoryBean.setLoginUrl("/usercontroller/notLogin");
        // 设置无权限时跳转的 url;
        shiroFilterFactoryBean.setUnauthorizedUrl("/usercontroller/notRole");
        ...
        //查询数据
        filterChainDefinitionMap.put("/server/**", "roles[admin]");
        //其余接口一律拦截
